...
const WHATSAPP_NUMBER = "+610481707758"; // Replace with actual number
...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-22 left-9 cursor-pointer z-50 flex flex-col items-end gap-3">
        <a
          ...
          >
        <span className="w-11 h-11 flex items-center justify-center rounded-full bg-[#25D366] text-white shrink-0">
