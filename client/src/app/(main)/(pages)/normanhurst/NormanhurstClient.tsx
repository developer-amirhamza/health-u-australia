...
import SlideModalForNormanhurst from 'app/(main)/components/SlideModalForNormanhurst'
          ...
          return (
            <div key={index}>
              <Image src={slide.image} className={`absolute  transition-opacity duration-1000 top-0 h-full  w-full  left-0  ${index === currentSlide ? "opacity-100" : "opacity-0"}
                object-cover`} alt={slide.heading || `${propertyData.title} - photo ${index + 1}`} />
              <motion.div
                initial={{
                  opacity: 0,
                  x: 80,
      ...
      <section className="py-8 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="w-full h-full flex items-center justify-center  border-5 border-secondary rounded   ">
            <iframe
              title="Map showing the Normanhurst NDIS housing location"
...
export default NormanhurstClient