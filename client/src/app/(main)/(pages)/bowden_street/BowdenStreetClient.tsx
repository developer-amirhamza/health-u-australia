...
import SlideModalForBowden from "app/(main)/components/SlideModalForBowden";
  ...
  return (
    <div className="flex flex-col w-full h-full  ">
          ...
          return (
            <div key={index}>
              <Image
                ...
                object-cover`}
                alt={slide.heading || `${propertyData.title} - photo ${index + 1}`}
              />
              <motion.div
                initial={{
                  opacity: 0,
      ...
      <section className="py-16 px-6 bg-gray-50">
        ...
        <iframe
            title="Map showing the Bowden Street Ryde NDIS housing location"
...
export default BowdenStreetClient;
